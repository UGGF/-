//
//  CreateNewAdressViewController.m
//  moonletScience
//
...
@interface CreateNewAdressViewController ()
{
    UIButton *_tickedBtn;
}
@end

@implementation CreateNewAdressViewController
...
#pragma mark - 修改状态栏的简便方法
    ...
    //导航栏字体
    UILabel *title = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH / 2 - 80 , 10, 160, 30)];
    title.text = @"新建收货地址";
...

{
    ...
    int offset = frame.origin.y + 100 - (HEIGHT - 216.0);//iPhone键盘高度216，iPad的为352
