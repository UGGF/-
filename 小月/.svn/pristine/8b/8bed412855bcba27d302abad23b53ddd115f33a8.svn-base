...
@interface ForbidGroupViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    NSArray *_array;
}
...
@implementation ForbidGroupViewController
...
#pragma mark - 修改状态栏的简便方法
    ...
    //导航栏字体
    UILabel *title = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH / 2 - 60 , 10, 120, 30)];
    title.text = @"禁止他(她)评论";
...
- (void)saveBtnClick{
    AddForbidViewController *add = [[AddForbidViewController alloc]init];
