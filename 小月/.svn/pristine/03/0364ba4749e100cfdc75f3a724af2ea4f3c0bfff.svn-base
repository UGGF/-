...
- (void)relaBtnClick:(UIButton *)sender{
    sender.selected = !sender.selected;
    self.friBtn.selected = !sender.selected;
    if (sender.selected == NO) {
        ...
        [self.friBtn setImage:[UIImage imageNamed:@"select.png"] forState:UIControlStateNormal];
    }
...
- (void)friBtnClick:(UIButton *)sender{
    sender.selected = !sender.selected;
    self.relaBtn.selected = !sender.selected;
    if (sender.selected == NO) {
        [sender setImage:[UIImage imageNamed:@"select.png"] forState:UIControlStateNormal];
        [self.relaBtn setImage:nil forState:UIControlStateNormal];
    }else{
        [sender setImage:nil forState:UIControlStateNormal];
        [self.relaBtn setImage:[UIImage imageNamed:@"select.png"] forState:UIControlStateNormal];
    }
