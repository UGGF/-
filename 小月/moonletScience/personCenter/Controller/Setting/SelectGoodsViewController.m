...
#import "SelectGoodTableViewCell.h"
#import "SureBuyViewController.h"

@interface SelectGoodsViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString *cellID = @"SelectGoodTableViewCell";
    SelectGoodTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
