...
@interface SureBuyViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,UITextViewDelegate>
{
...
- (void)viewDidLoad {
    ...
    _array = @[@"王三",@"15888122479",@"浙江省宁波市江东区中山东路455号东海曙光大厦20楼B1"];
...
- (void)createBgLine{
    ...
    UIView *line1 = [[UIView alloc]initWithFrame:CGRectMake(0, 70+15+15+5+90, WIDTH, 5)];
...
- (void)createShippingInfoView{
    ...
    shInLab.font = [UIFont systemFontOfSize:16];
    shInLab.textAlignment = NSTextAlignmentLeft;
    [self.view addSubview:shInLab];
    
    UILabel *deLab = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-70, 70+15, 60, 20)];
    deLab.text = @"[默认]";
    deLab.textColor = CAOGREENCOLOR;
    deLab.font = [UIFont systemFontOfSize:16];
...
- (void)createTableView{
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 70+15+15+5, WIDTH-30, 90)];
...
//    cell.myLable.backgroundColor = REDCOLOR;
    ...
    if (![_temp  isEqual: @"中国"] && ![_temp  isEqual: @""]) {
        _postageLab = [[UILabel alloc]initWithFrame:CGRectMake(15, 73, 200, 20)];
...
- (void)createProInfoView{
    ...
    moonLab.font = [UIFont systemFontOfSize:13];
    ...
    editionLab.font = [UIFont systemFontOfSize:13];
    editionLab.textAlignment = NSTextAlignmentLeft;
    [self.view addSubview:editionLab];
    
    UILabel *typeLab = [[UILabel alloc]initWithFrame:CGRectMake(15+120+10, 190+30+20, 120, 20)];
    ...
    colorLab.font = [UIFont systemFontOfSize:13];
    ...
    signNumLab.font = [UIFont systemFontOfSize:14];
...
//    }
    ...
    int tempNum = 2;
    UILabel *inFoLab = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH/2-20, 190+20+20+20+5+20+40+10+20, 120, 20)];
    ...
    couponPriLab.font = [UIFont systemFontOfSize:15];
...
//    [self.view addSubview:cPriLab];
    ...
    self.message = [[UITextView alloc]initWithFrame:CGRectMake(10, 190+20+20+20+5+20+40+10+5+20+20+20+10+10+10, WIDTH-20, 60)];
    ...
    self.tempLab = [[UILabel alloc]initWithFrame:CGRectMake(5, 0, 100, 20)];
    self.tempLab.text = @"给厂家留言";
    self.tempLab.textColor = TEXTTINTCOLOR;
    self.tempLab.font = [UIFont systemFontOfSize:14];
    [self.message addSubview:self.tempLab];
    
    
    
    UILabel *shouldLab = [[UILabel alloc]initWithFrame:CGRectMake(10, 190+20+20+20+5+20+40+10+5+20+20+60+10+35+10+10+20, 80, 20)];
    shouldLab.text = @"应付总额:";
    ...
    UILabel *shouldTotalLab = [[UILabel alloc]initWithFrame:CGRectMake(10+80, 190+20+20+20+5+20+20+40+10+5+20+10+60+10+35+30, 15, 20)];
    shouldTotalLab.text = @"¥";
    ...
    if ([_temp isEqual:@"中国" ] && [_temp isEqual:@"" ]) {
        int z = a ;
        UILabel *payTotalLab = [[UILabel alloc]initWithFrame:CGRectMake(10+80+15, 190+20+20+20+5+20+20+40+10+5+20+10+60+10+35+30, 100, 20)];
    ...
    payBtn.frame = CGRectMake(WIDTH-80, 190+20+20+20+5+20+40+10+5+20+10+60+5+35+20+30, 60, 30);
