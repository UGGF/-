...
//    losePSW.frame = CGRectMake(WIDTH - 100 , 235, 100, 40);
    ...
    //设置居中
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:losePSW attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
    
    vfl1 = @"V:|-235-[losePSW(40)]-|";
...
//        _logoinDict = dict;
//        NSNumber *status = [_logoinDict objectForKey:@"status"];
//        
...
//            
//            //创建一个字典
//            NSMutableDictionary *dic = [NSMutableDictionary dictionaryWithObjectsAndKeys:[[_logoinDict objectForKey:@"buyerList"] objectForKey:@"id"],@"id",[[_logoinDict objectForKey:@"buyerList"] objectForKey:@"loginName"],@"loginName",[[_logoinDict objectForKey:@"buyerList"] objectForKey:@"loginPass"],@"loginPass",nil];
//            //把数据写入plist文件
//            
...
//            danli.teamId = [[[dict objectForKey:@"buyerList"] objectForKey:@"teamId"] stringValue];
//            danli.userId = [[_logoinDict objectForKey:@"buyerList"] objectForKey:@"id"];
//            danli.userName = [[_logoinDict objectForKey:@"buyerList"] objectForKey:@"name"];
//            danli.userJf = [[_logoinDict objectForKey:@"buyerList"] objectForKey:@"jf"];
//            danli.userMoney = [[_logoinDict objectForKey:@"buyerList"] objectForKey:@"money"];
//            danli.headerPic = [[_logoinDict objectForKey:@"buyerList"] objectForKey:@"headPic"];
//            danli.isLogoin = YES;
//            
...
//        {
//            UIAlertView* alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"温馨提示", nil) message:NSLocalizedString([_logoinDict objectForKey:@"message"], nil) delegate:nil cancelButtonTitle:@"好的" otherButtonTitles:nil, nil];
//            [alert show];
