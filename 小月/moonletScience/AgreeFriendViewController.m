...
@interface AgreeFriendViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
- (void)creatImageInfo{
    ...
    UILabel *la = [[UILabel alloc]initWithFrame:CGRectMake(20, 0, 40, HEIGHT/14)];
    la.text = @"关注:";
    la.textColor = TEXTTINTCOLOR;
    la.font = [UIFont systemFontOfSize:11];
    [careView addSubview:la];
    
    UILabel *numla = [[UILabel alloc]initWithFrame:CGRectMake(50, 0, 80, HEIGHT/14)];
    numla.text = @"1209";
    numla.textColor = TEXTTINTCOLOR;
    numla.font = [UIFont systemFontOfSize:12];
    [careView addSubview:numla];
    
    UILabel *tuila = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-100, 0, 50,  HEIGHT/14)];
    tuila.text = @"推荐指数:";
    tuila.textColor = TEXTTINTCOLOR;
    tuila.font = [UIFont systemFontOfSize:11];
    [careView addSubview:tuila];
    
    UILabel *numlable = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-45, 0, 80,  HEIGHT/14)];
    numlable.text = @"1869";
